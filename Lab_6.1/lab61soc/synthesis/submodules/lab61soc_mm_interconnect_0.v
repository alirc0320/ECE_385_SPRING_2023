...
module lab61soc_mm_interconnect_0 (
	...
	wire   [85:0] sdram_s1_agent_rp_data;                                                             // sdram_s1_agent:rp_data -> router_006:sink_data
	...
	wire  [103:0] cmd_demux_001_src5_data;                                                            // cmd_demux_001:src5_data -> cmd_mux_005:sink1_data
	...
	wire  [103:0] rsp_demux_005_src1_data;                                                            // rsp_demux_005:src1_data -> rsp_mux_001:sink5_data
	...
	wire   [85:0] router_006_src_data;                                                                // router_006:src_data -> sdram_s1_rsp_width_adapter:in_data
	wire          router_006_src_ready;                                                               // sdram_s1_rsp_width_adapter:in_ready -> router_006:src_ready
	wire    [7:0] router_006_src_channel;                                                             // router_006:src_channel -> sdram_s1_rsp_width_adapter:in_channel
	...
	wire  [103:0] cmd_demux_src4_data;                                                                // cmd_demux:src4_data -> crosser:in_data
	...
	wire  [103:0] crosser_out_data;                                                                   // crosser:out_data -> cmd_mux_004:sink0_data
	...
	wire  [103:0] crosser_001_out_data;                                                               // crosser_001:out_data -> cmd_mux_004:sink1_data
	wire          crosser_001_out_ready;                                                              // cmd_mux_004:sink1_ready -> crosser_001:out_ready
	wire    [7:0] crosser_001_out_channel;                                                            // crosser_001:out_channel -> cmd_mux_004:sink1_channel
	...
	wire  [103:0] rsp_demux_004_src0_data;                                                            // rsp_demux_004:src0_data -> crosser_002:in_data
	wire          rsp_demux_004_src0_ready;                                                           // crosser_002:in_ready -> rsp_demux_004:src0_ready
	wire    [7:0] rsp_demux_004_src0_channel;                                                         // rsp_demux_004:src0_channel -> crosser_002:in_channel
	...
	wire  [103:0] crosser_002_out_data;                                                               // crosser_002:out_data -> rsp_mux:sink4_data
	wire          crosser_002_out_ready;                                                              // rsp_mux:sink4_ready -> crosser_002:out_ready
	wire    [7:0] crosser_002_out_channel;                                                            // crosser_002:out_channel -> rsp_mux:sink4_channel
	...
	wire  [103:0] rsp_demux_004_src1_data;                                                            // rsp_demux_004:src1_data -> crosser_003:in_data
	wire          rsp_demux_004_src1_ready;                                                           // crosser_003:in_ready -> rsp_demux_004:src1_ready
	wire    [7:0] rsp_demux_004_src1_channel;                                                         // rsp_demux_004:src1_channel -> crosser_003:in_channel
	...
	lab61soc_mm_interconnect_0_router_006 router_006 (
	...
	lab61soc_mm_interconnect_0_avalon_st_adapter_004 #(
		.inBitsPerSymbol (18),
		.inUsePackets    (0),
		.inDataWidth     (18),
		.inChannelWidth  (0),
